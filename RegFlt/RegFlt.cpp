...
NTSTATUS _RfSplitParentAndRelativeNames(__in PCUNICODE_STRING pFullObjectName,
                                        __out_opt PUNICODE_STRING pParentObjectName,
                                        __out_opt PUNICODE_STRING pRelativeObjectName);
extern "C" DRIVER_INITIALIZE DriverEntry;
extern "C" NTSTATUS DriverEntry(__in PDRIVER_OBJECT pDriverObject, __in PUNICODE_STRING pRegistryPath);
NTSTATUS RfKeyHandleClose(__in PVOID CallbackContext, __in PVOID Argument1,
                          __in PREG_KEY_HANDLE_CLOSE_INFORMATION CallbackData);
NTSTATUS RfPreCreateKeyEx(__in PVOID CallbackContext, __in PVOID Argument1,
                          __in PREG_CREATE_KEY_INFORMATION CallbackData);
...
NTSTATUS RfPreRenameKey(__in PVOID CallbackContext, __in PVOID Argument1,
                        __in PREG_RENAME_KEY_INFORMATION CallbackData);
